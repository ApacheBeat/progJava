...
public class PR2_Ex3_2_Test {
    ...
    @Test
    public void taskUndeployService() {                        
        ...
        // Stop the services
        try {            
            manager.stopService(service2);            
            manager.stopService(service1);            
        } catch (Throwable t) {                        
            fail();            
        }
    ...
    @Test
    public void taskUndeployUnexistingService() {                        
        assertEquals(0, service1.getInstances());
        assertEquals(0, service2.getInstances());
        assertEquals(0, manager.getRunningServices().size());
        assertEquals(0, manager.getHostServices(host1).size());
        ...
        assertEquals(TaskStatus.FAILED, manager.getTasks().get(0).getStatus());
